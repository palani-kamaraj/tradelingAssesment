...
interface NotFoundSvgIconProps {
  title: string;
}

const NotFoundSvgIcon = (props: NotFoundSvgIconProps) => {
  const { title = "Oops, Something went wrong" } = props;
  return (
    <div className="NotFoundSvgIcon">
    <svg
    ...
    >
      ...
      />
      <path
        d="M91.68 47.71l-.75-11.2-11.78 7.33-1.69 3.87h-1.67c0 3.36 3.76 6.08 8.4 6.08s8.4-2.72 8.4-6.08z"
        className="cls-4"
      />
      <path
      ...
      />
      <path d="M92.59 32.22V28.5l-15.82-.79v4.51h15.82z" className="earMove" />
      <circle
        cx="78.06"
        cy="34.04"
        r="2.47"
      ...
      />
      <path
        d="M81.74 57.06l-21.11-7.34a6.72 6.72 0 1 0-2.93 12.77h35.55c0-5.71-11.51-5.43-11.51-5.43zM77.46 25h13.46v14.38a6.73 6.73 0 0 1-6.73 6.73 6.73 6.73 0 0 1-6.73-6.73V25z"
        className="cls-4"
      />
      <path
        style={{ fill: "#4f86ed" }}
      ...
      <path
        style={{ fill: "#4f86ed" }}
        id="c-4"
        d="M82.44 23.89l9.74.43.41.02-.11 2.5-11.52-.51 1.48-2.44z"
      ...
      <path
        d="M112.2 53l-9.87-21.92-3-5.48-11.86-.22 7.42 3.35h-3.34l5.82 4.58 2 22.26A6.72 6.72 0 1 0 112.2 53z"
        className="cls-4"
      />
      <ellipse cx="80.09" cy="33.12" className="faceMove" rx=".53" ry=".59" />
      <ellipse cx="86.34" cy="33.12" className="faceMove" rx=".53" ry=".59" />
      <path
        d="M84.19 31.08l-2.45 5.93h2.65M83.06 40.36a4 4 0 0 1 2.75-1"
        className="cls-10 faceMove"
      />
      <path
        d="M81.07 30.33l-2.6.25M86.34 30.45l1.81.63"
        className="cls-11 faceMove"
      />
      <path
        d="M106.86 47.82l4.13-1.71M107.43 49.9l4.12-1.71M107.99 51.98l4.12-1.71"
        className="cls-12"
      />
      <g className="cls-13">
...
export default NotFoundSvgIcon;
